Download URL: https://sourceforge.net/projects/popbit/files/Popbit/popbit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PBT fee schedule (users still pay 0.01 PBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #popbit00 - #popbit99
