Popbit Core version 0.9.4 is now available from:

  https://popbit.org/bin/0.9.4/
...
this update is incompatible with the Popbit system and could lead to consensus
forks.

Popbit Core released binaries from https://popbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~popbit/+archive/ubuntu/popbit
- A third-party or self-compiled Popbit Core

upgrade to Popbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
