Popbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/popbit/files/Popbit/popbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Popbit
...
New/changed settings (command-line or popbit.conf file)
--------------------------------------------------------
