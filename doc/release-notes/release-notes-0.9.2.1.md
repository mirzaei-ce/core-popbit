Popbit Core version 0.9.2.1 is now available from:

  https://popbit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PBT to 0.01 PBT
...
- Fix "Start popbit on system login"
