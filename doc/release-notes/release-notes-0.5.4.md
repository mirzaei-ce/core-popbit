Popbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/popbit/files/Popbit/popbit-0.5.4/
...
http://gitorious.org/popbit/popbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Popbit-Qt notifications under Growl 1.3.
Increase required age of Popbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPopbit properly when installing Popbit-Qt over it. (Windows)
