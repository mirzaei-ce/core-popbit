...
unlocked to sign the Popbit-Qt.app bundle.
...
allowing somebody to distribute a Popbit-Qt.app or popbit-qt-setup.exe with a valid
...
that the popbit-qt.exe file inside the installer had not been tampered with.
