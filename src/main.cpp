...
#if defined(NDEBUG)
# error "Popbit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Popbit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s PBT additional fees, %d delta bytes\n",
