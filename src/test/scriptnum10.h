...
#ifndef POPBIT_TEST_SCRIPTNUM10_H
#define POPBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Popbit Core 0.10.0, for cross-comparison.
 */
public:
