...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CPopbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CPopbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CPopbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CPopbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CPopbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CPopbitAddress(arr[0].get_str()).Get() == demoAddress.Get());
