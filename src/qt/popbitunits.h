...
#ifndef POPBIT_QT_POPBITUNITS_H
#define POPBIT_QT_POPBITUNITS_H
...
/** Popbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PopbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PopbitUnits(QObject *parent);

    /** Popbit units.
      @note Source: https://en.popbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PBT,
...
typedef PopbitUnits::Unit PopbitUnit;

#endif // POPBIT_QT_POPBITUNITS_H
