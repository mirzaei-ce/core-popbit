...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/popbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Popbit Core"),
     ...
     * override -datadir in the popbit.conf file in the default data directory
     * (to be consistent with popbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
